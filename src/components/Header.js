        ...
        <div className='container flex align-center f-space-between'>
            ...
            <nav className={expand ? 'expanded' : ''}>
                <ul className='flex nav-menu'>
                    <li onClick={()=>setExpand(false)}><i class="fa-solid fa-kitchen-set"></i><Link to='/what-2-cook/byingridient'>Recipes Based on ingredient</Link></li>
                    <li onClick={()=>setExpand(false)}><i class="fa-regular fa-bookmark"></i><Link to='/what-2-cook/bookmarked'>Saved Recipes</Link></li>
                </ul>
            </nav>
        </div>
